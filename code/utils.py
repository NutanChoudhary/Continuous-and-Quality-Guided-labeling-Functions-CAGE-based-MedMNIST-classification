def custom_dataset(classes=[2, 4, 5], path="D://project//data//", fraction=0.2):
    import numpy as np
    from sklearn.model_selection import train_test_split

    data = np.load(path + "dermamnist.npz")
    custom_data = {'train_images': [], 'train_labels': [], 'val_images': [], 'val_labels': [], 'test_images': [],
                   'test_labels': []}
...
def custom_random_dataset(classes=[2, 4, 5], path="D://project//data//", fraction=0.2):
    import numpy as np
    from sklearn.model_selection import train_test_split
...
def custom_random_seeds(classes=[2, 4, 5], path="D://project//data//", fraction=0.2, n_seeds=7):
    import numpy as np
    from sklearn.model_selection import train_test_split
    ...
    for i in range(n_seeds):
        x_train, y_train, indices = random_seed(custom_data['rem_images'], custom_data['rem_labels'], classes,
                                                img_per_class)
